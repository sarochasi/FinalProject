...
INSERT INTO `media` (`id`, `user_id`, `source_url`, `name`, `created_at`, `updated_at`, `description`, `enabled`) VALUES (2, 1, 'https://www.youtube.com/embed/dMH0bHeiRNg?si=j1GG50nNIPYQ9t0C', 'Evolution of Dance', NULL, NULL, 'A progression through history and its iconic boogies', 1);
...
INSERT INTO `media` (`id`, `user_id`, `source_url`, `name`, `created_at`, `updated_at`, `description`, `enabled`) VALUES (4, 1, 'https://www.youtube.com/embed/BBGEG21CGo0?si=cVp4QGoXqzFpJ0-h', 'Gandalf Saxophone', NULL, NULL, 'Perfect for idle background music', 1);
